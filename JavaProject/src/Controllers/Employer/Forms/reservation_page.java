...
public class reservation_page implements Initializable {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        try {
            while (rs.next()) {
                table_view.getItems().add(new info_reserve(rs.getInt(1), rs.getString(2), rs.getInt(3),rs.getInt(4), rs.getDate(5),rs.getInt(6)));
                // System.out.println(rs.getInt(1) + "\n" + rs.getString(2) + "\n" +
                //         rs.getInt(3));
                //List.add(new info_reserve(rs.getInt(1), rs.getString(2), rs.getInt(3),rs.getInt(4), rs.getDate(5),rs.getInt(6)));
            }
